...
router.post('/insert',function(req,res){
	...
	id = cassandra.types.uuid();
				...
				const params = {s_id : id , s_name : req.body.s_name, s_established : req.body.s_established , s_location : req.body.location , s_descriptions : req.body.s_description};
				client.execute( query , params , { prepare: true } , function(err, result) {
                      if(err){
                        console.log('ERROR FIND!!! IS '+err);
												...
												var query = "INSERT INTO registration.detail (d_id,control_humid,control_temp,finish_time,s_name,start_time) VALUES (:d_id,:control_humid,:control_temp,:finish_time,:s_name,:start_time);";
