...
id = cassandra.types.uuid();
	...
	var humid = parseFloat(req.body.control_humid);
	var temp = parseFloat(req.body.control_temp);

	var insertdetail = "INSERT INTO registration.detail (s_name, control_humid, control_temp, start_time ,finish_time) VALUES (?,?,?);";
				client.execute(insertdetail,[req.body.s_name, humid, temp],{prepare:true});
